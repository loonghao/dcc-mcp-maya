...
[![dcc-mcp-core](https://img.shields.io/badge/dcc--mcp--core-%3E%3D0.17.29-blue)](https://github.com/loonghao/dcc-mcp-core)
...
```bash
mayapy -m pip install "dcc-mcp-server>=0.17.29"
...
- Autodesk Maya 2020+
- Python 3.7+
- `dcc-mcp-core>=0.17.29,<1.0.0`
- Standard sidecar binary for plugin mode: `dcc-mcp-server>=0.17.29`
